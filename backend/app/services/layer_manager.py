...
class LayerManager:
    ...
    async def load_core_layers(self):
        ...
        logger.info(f"Scanning core layers directory: {core_dir}")
        for layer_dir in core_dir.iterdir():
            ...
            try:
                ...
                logger.info(f"Successfully loaded core layer {layer_id}")
            except Exception as e:
                logger.error(f"Failed to load core layer {layer_id}: {e}", exc_info=True)
